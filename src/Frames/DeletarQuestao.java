 ...
 * @author Gustavo
 */
public class DeletarQuestao extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPage
     */
    public DeletarQuestao() {
        initComponents();
        try{
        ...
        {
            CustomDialogBox ccb = new CustomDialogBox("Pesquise um ID antes de deletar.");
            ccb.setVisible(true);
            return false;
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 140, -1));
        ...
        rSButtonHover3.setText("Excluir");
        ...
        jLabel13.setText("uma Questão existente");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 470, -1));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(1390, 760, 110, -1));
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        ...
        try{
            ...
            if(rs.first()){
                ...
                JFrame jf = new JFrame();
                jf.setAlwaysOnTop(true);
                CustomDialogBox cdb = new CustomDialogBox("Este ID da questão não existe.");
                cdb.setVisible(true);
            }
    ...
    private void rSButtonHover3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover3ActionPerformed
        if(validateNumberToQuery())
        {
            if(validateLength())
            {
                Usuario.consultaIdExcluir = consulta_id.getText();
                CustomConfirmBox ccb = new CustomConfirmBox("Você deseja Excluir esta questão?", this);
                ccb.setVisible(true);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletarQuestao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeletarQuestao().setVisible(true);
            }
        });
    }
